...
function FiveLevels() {
  return (<div>
    <SectionTitle pt="O Framework de Cinco Níveis">The Five-Level Framework</SectionTitle>
    <Card title="Three Critical Insights (Ch.2)" pt="Três percepções fundamentais" color="blue">
      <div className="grid grid-cols-3 gap-2">
        {[["Systemic Sistêmico","Levels interdependent; changes cascade"],["Changing Mudança contínua","Must project forward, not snapshot"],["Interdependent Interdependente","Favorable macro ≠ firm success if micro/firm unfavorable"]].map(([t,d])=>(<div key={t} className="bg-white border rounded p-3 text-center"><div className="font-bold text-blue-700 text-sm mb-1">{t}</div><div className="text-xs text-slate-600">{d}</div></div>))}
      </div>
    </Card>
    <div className="bg-slate-800 text-white rounded-xl p-5 mb-4">
      ...
      <div className="space-y-3">
        ...
        <div className="bg-teal-900 rounded-lg p-3"><div className="flex items-center gap-2 mb-2"><Tag color="cyan">MESO Cluster</Tag><span className="text-xs text-teal-300">Related firms, suppliers, customers</span></div><div className="flex flex-wrap gap-1">{["Demand & Customers","Inputs & Suppliers","Shared Resources","Shared Activities","Complementarities","Substitutes","Meso Policies","Meso Institutions"].map(d=>(<span key={d} className="bg-teal-800 text-teal-200 text-xs px-2 py-0.5 rounded">{d}</span>))}</div></div>
        <div className="bg-amber-900 rounded-lg p-3"><div className="flex items-center gap-2 mb-2"><Tag color="amber">MICRO Indústria</Tag><span className="text-xs text-amber-300">Competitive environment</span></div><div className="flex flex-wrap gap-1">{["Industry Characteristics","Competition","Cooperation","Strategic Groups","Lead Firms","Micro Policies","Micro Institutions"].map(d=>(<span key={d} className="bg-amber-800 text-amber-200 text-xs px-2 py-0.5 rounded">{d}</span>))}</div></div>
      ...
      <div className="mt-4 bg-slate-700 rounded p-3 text-center">
        ...
        <div className="text-slate-400 text-xs mt-1">Esse driver contribui de forma <strong>positiva ou negativa</strong> para a lucratividade ou crescimento lucrativo?</div>
      </div>
    </div>
    <Card title="Levels AND Trends (Ch.2)" pt="Níveis E Tendências" color="amber">
      <div className="text-center font-semibold">"Better might still not be good. Worse might still not be bad."</div>
      <div className="text-center text-xs text-slate-500 mt-1">Melhorar não significa necessariamente que está bom. Piorar não significa necessariamente que está ruim.</div>
    </Card>
    <Card title="Q1 Template" pt="Modelo de resposta rápida para Q1" color="green">
      ...
      <div className="mt-2 bg-red-50 border border-red-300 rounded p-2 text-xs">⚠️ Q1 exige 5 casos diferentes, um por nível. <strong>Complete com suas anotações das Sessions 1–8.</strong></div>
    </Card>
  </div>);
}
...
function SparkPosition() {
  return (<div>
    ...
    <Card title="Positioning: The Full Picture (Ch.3, Figs 3.3–3.5)" pt="Posicionamento: Ponto mais cobrado e mais errado na prova" color="red">
      <div className="bg-red-50 border border-red-200 rounded p-3 mb-3 text-center">
        ...
        <div className="text-xs text-slate-500 mt-1">Somente a MARGEM (Preço − Custo) revela a verdade</div>
      </div>
    ...
    <Card title="A-R-K Advantage Logic" pt="Lógica de vantagem de Atividades-Recursos-Conhecimento" color="purple">
    ...
    <Card title="Time Dimension (Ch.3)" pt="Dimensão temporal da estratégia" color="cyan">
    ...
    <Card title="General vs. Specific Competitive Advantages (Ch.3)" pt="Vantagens competitivas gerais vs. específicas" color="amber">
      <div className="grid grid-cols-2 gap-3 text-xs">
        <div className="bg-amber-50 border rounded p-3"><div className="font-bold text-amber-700 mb-1">General Gerais</div><div>Built up over time: R&D, brands, manufacturing excellence.</div></div>
      ...
      <div className="mt-2 text-xs text-center">Hustle = criar vantagens gerais para gerar continuamente as vantagens específicas necessárias para competir agora.</div>
    </Card>
    <Card title="Scope Combinations (Ch.3, Fig 3.1)" pt="Matriz de combinações de Escopo" color="slate">
    ...
    <Card title="Activities & Resources Lists (Lecture Ch.3)" pt="Listas de Atividades e Recursos" color="green">
      <div className="grid grid-cols-2 gap-3 text-xs">
    ...
    <Card title="Signals of Value (Ch.3)" pt="Sinais de valor — impactam a disposição a pagar" color="rose">
...
function IndustryTab() {
  return (<div>
    <SectionTitle pt="Análise no Nível da Indústria (Ch.4)">Industry-Level Analysis</SectionTitle>
    <Card title="Industry Definition — CRITICAL" pt="Definição de indústria — EXTREMAMENTE IMPORTANTE" color="red">
    ...
    <Card title="Competition Spectrum" pt="Espectro de tipos de competição" color="amber">
      ...
      <div className="flex justify-between text-xs text-slate-500 px-1"><span>← Mais competição, menor lucro</span><span>Menos competição, maior lucro →</span></div>
      <div className="mt-2 bg-amber-50 border border-amber-300 rounded p-2 text-xs">⚠️ <strong>"Segmented competition"</strong> — adição manuscrita do professor. Não omita.</div>
    </Card>
    <Card title="Conditions for Perfect Competition" pt="Condições para competição perfeita (desvios = explicam lucro)" color="slate">
      ...
      <div className="mt-2 text-xs font-semibold text-center">Desvios dessas condições → explicam por que lucros existem</div>
    </Card>
    <Card title="Industry-Level Driver Checklist" pt="Lista de drivers no nível da indústria" color="blue">
    ...
    <Card title="Barriers to Entry & Exit (Ch.4)" pt="Barreiras de entrada e saída — explicam por que diferenças de lucro persistem" color="purple">
      <div className="grid grid-cols-2 gap-3 text-xs">
        <div><div className="font-semibold text-purple-700 mb-1">Entry Barriers Barreiras de entrada:</div><ul className="space-y-0.5 list-disc list-inside"><li>Economies of scale, learning, scope</li><li>Brands and differentiation</li><li>Patents and government regulation</li><li>Access to inputs or distribution</li><li>Expected retaliation</li></ul></div>
        <div><div className="font-semibold text-purple-700 mb-1">Exit Barriers Barreiras de saída:</div><ul className="space-y-0.5 list-disc list-inside"><li>Specialized assets</li><li>Strategic barriers</li><li>Emotional barriers</li><li>Large costs of exiting</li></ul></div>
      </div>
    ...
    <Card title="Table 4.3: Features by Competition Type" pt="Tabela de características por tipo de competição" color="slate">
    ...
    <Card title="Competitor Envelope Analysis — CEA (Ch.4)" pt="Análise de envelope do concorrente" color="rose">
    ...
    <Card title="Quality vs. Price Competition (Lecture Ch.4)" pt="Competição por qualidade vs. preço" color="green">
...
function MesoCluster() {
  return (<div>
    ...
    <Card title="Business Ecosystem Warning (Lecture Ch.5 Part 2)" pt="Alerta sobre ecossistemas de negócios" color="red">
      <div className="bg-red-100 border border-red-300 rounded p-3 text-center"><div className="font-bold text-red-800 text-sm">Where is value GENERATED, APPROPRIATED, and DEFENDED?</div><div className="text-xs text-red-700 mt-1">Onde o valor é GERADO, APROPRIADO e DEFENDIDO?</div></div>
    </Card>
    <Card title={`"It's a Wonderful Life" Test (Lecture Ch.5 Part 1)`} pt="Se um participante for removido, o que acontece?" color="purple"><div className="text-xs">Imagine removing a player from the ecosystem. If the industry would be significantly worse off, that player has substantial power. If barely noticed, they do not.</div></Card>
    <Card title='"When Will Buyers Get the Value?" (Lecture Ch.5 Part 1)' pt="Quando os compradores capturarão o valor?" color="amber">
...
function MacroMeta() {
  return (<div>
    ...
    <Card title="MACRO / NATIONAL (Ch.6)" pt="Nível Nacional" color="blue">
      ...
      <div className="bg-amber-50 border border-amber-300 rounded p-3 text-xs"><strong>Notas Ch.6:</strong> Observe <Tag color="amber">Níveis</Tag> <Tag color="amber">Tendências</Tag> <Tag color="amber">Disrupção</Tag> <Tag color="amber">Mudanças não-lineares</Tag></div>
    </Card>
    ...
    <Card title="Writing Standard for Macro & Meta" pt="Padrão de escrita para respostas" color="red">
      <div className="grid grid-cols-2 gap-3 text-xs">
...
function VrioArk() {
  return (<div>
    ...
    <Card title="VRIO Framework (extended in this course)" pt="Framework VRIO (estendido neste curso)" color="purple">
    ...
    <Card title="Q2A: Home Alone — Professor's Own Answer" pt="Resposta do próprio professor (Lecture Notes Ch.5 Part 1, slide 20)" color="green">
      ...
      <div className="mt-2 text-xs font-semibold text-center">Chave: O que é "escasso" MUDA ao longo do tempo. VRIO é dinâmico. Poder de barganha segue a escassez.</div>
    </Card>
    <Card title="Q2B: Natalie Portman — Three-Picture Deal" pt="Pergunta sobre ferramentas de influências externas" color="blue">
    ...
    <Card title="Q2C: Hollywood Flops — Limits of VRIO" pt="Limites do VRIO" color="red">
...
function EtaSwatch() {
  return (<div>
    ...
    <Card title="Key Facts to Know Cold" pt="Fatos que você deve saber de cor" color="blue">
    ...
    <Card title="ETA Timeline" pt="Linha do tempo" color="slate">
    ...
    <Card title="Movement vs Watch Economics" pt="Comparação econômica: movimentos vs. relógios" color="slate">
      <table className="w-full text-xs"><thead><tr><th className="text-left pb-1"></th><th className="text-left pb-1 text-blue-700">Movements Movimentos</th><th className="text-left pb-1 text-amber-700">Watches Relógios</th></tr></thead>
...
function CramSheet() {
  return (<div>
    ...
    <div className="bg-slate-900 text-white rounded-xl p-5 mb-4">
      ...
      <div className="space-y-2">
        {[
          ["1","Performance is RELATIVE","Desempenho é RELATIVO","blue"],
          ["2","Comprehensive, integrative, dynamic, question-based","Abrangente, integrativo, dinâmico, baseado em perguntas","blue"],
          ["3","Five levels. At each: positive or negative?","5 níveis. Em cada: positivo ou negativo?","blue"],
          ["4","Levels AND trends","Níveis E tendências","blue"],
          ["5","Industry = similar form + function + direct competition","Indústria = forma+função similar+competição direta","amber"],
          ["6","Full positioning = price AND cost","Posicionamento completo = preço E custo","green"],
          ["7","SPARK: Scope, Positioning, Activities, Resources, Knowledge","","green"],
          ["8","VRIO extends to ARK in SPARK","VRIO se estende ao ARK no SPARK","purple"],
          ["9","Complementors EXPAND; substitutes CONTRACT demand","Complementares expandem; substitutos contraem demanda","cyan"],
          ["10","Ecosystems: where is value generated, appropriated, defended?","Ecossistemas: onde o valor é gerado, apropriado, defendido?","red"],
          ["11","Macro: levels, trends, disruption, non-linearity","Macro: níveis, tendências, disrupção, não-linearidade","blue"],
          ["12","Q2 Home Alone: THE PART → THE KID → THE FRANCHISE","","green"],
          ["13","Q3 ETA: 5yr, CHF 10M, 33% by 2019, more concentrated","","amber"],
          ["14","Barriers to entry/exit allow profit differences to PERSIST","Barreiras fazem diferenças de lucro persistirem","purple"],
          ["15","Competitor Envelope Analysis: what if competitors optimize?","Análise de envelope: e se concorrentes otimizarem?","rose"],
          ["16","General vs. Specific advantages → explains hustle logic","Vantagens gerais vs. específicas","cyan"],
          ["17",`"Wonderful Life" test: remove a player, does it matter?`,"Remova um participante, faz diferença?","purple"],
        ].map(([n,en,pt,c])=>{
    ...
    <Card title="Mistakes That Cost Points" pt="Erros que mais custam pontos" color="red">
    ...
    <div className="bg-slate-100 rounded-lg p-4 text-center">
      ...
      <div className="text-xs text-slate-500 mt-1">Identifique o nível → Identifique o driver → Explique o mecanismo → Julgue o efeito no desempenho</div>
    </div>
...
export default function App() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="bg-slate-900 text-white px-4 py-3"><div className="text-lg font-bold">STRT 6200 Midterm Study Guide</div><div className="text-xs text-slate-400">English - Português Brasileiro | Closed Book</div></div>
